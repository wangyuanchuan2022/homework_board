...
urlpatterns = [
    ...
    path("rating/rate/<int:rating_id>/", views.rate_rating, name="rate"),
    path("rating/comment/<int:rating_id>/", views.comment_rating, name="comment_rating"),
    path("rating/comment/reply/<int:comment_id>/", views.reply_comment, name="reply_comment"),
    path("rating/comment/like/<int:comment_id>/", views.like_comment, name="like_rating_comment"),
    path("rating/comment/delete/<int:comment_id>/", views.delete_comment, name="delete_rating_comment"),
    ...
    path("api/comments/delete/", views.delete_hot_topic_comment, name="delete_comment"),
